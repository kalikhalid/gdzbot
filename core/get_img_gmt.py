...
def download_imgs(url, path, filedir):
	...
	with open(filedir + '/' + filename, "wb") as f:
		for data in response.iter_content(1024):
			f.write(data)
def get_images_gmt(url, pathname, filedir):
	...
	deletefilearr = ['crown.svg',
		...
		'star-icon.svg',
		'geometriya-7-9-klass-atanasyan.jpg',
		'geometriya-7-klass-atanasyan-rabochaya-tetrad.jpg',
		'geometriya-9-klass-rabochaya-tetrad-atanasyan.jpg',
	]
